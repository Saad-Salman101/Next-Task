    ...
    return (
        < >
            <div className='address-container flex items-center w-full'>
                <div className='text-[13px] font-light leading-[25px] w-auto font-Lato' >SHELTON STREET  COVENT GARDEN LONDON  WC2H UNITED KINGDOM</div>
            </div>
            <div className='flex justify-between items-center w-full'>
                ...
                <div className='flex flex-col justify-center align-middle items-start ml-5 md:ml-10 lg:w-1/12'>
                    <div className='text-[14px] leading-[30px] w-auto text-center'>£ {price} GBP</div>
                    <div className='text-[9px] leading-[12px] w-auto text-center'>#ZM{id}</div>
                </div>
