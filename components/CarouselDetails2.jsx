    ...
    return (
        < >
            <div className='address-container flex items-center w-full'>
                <div className='text-[13px] font-light leading-[25px] w-auto font-Lato tracking-[1.2px]' >{mydata.details.address}</div>
            </div>
            <div className='flex justify-around items-center w-full  mb-3 '>
                ...
                <div className='flex flex-col  align-middle items-start '>
                    <div className='text-[14px] flex leading-[30px] w-auto text-left tracking-[1.2px]'><div>£ </div> {mydata.price} <div className='ml-1'>{mydata.currency}</div></div>
                    <div className='text-[9px] leading-[12px] w-auto ml-5 text-right tracking-[1.2px]'>#ZM{mydata.id}</div>
                </div>
